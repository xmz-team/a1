...
# export -f Error_uid_Check_a1
# export -f _err_uid_check
export -f init_config
export -f check_config_conflict
export -f save_config
export -f check_a1_running
export -f check_if_should_run_a1
export -f auto_apply_check
export -f show_help
export -f check_status
export -f start_a1
export -f start_a1_service
export -f start_a1_foreground
export -f a1_kill_pid
export -f return_priority
export -f update_config
export -f set_auto_apply
export -f show_config
export -f add_priority
export -f remove_priority
export -f list_priority
export -f clear_priority
export -f configure_sudo_permissions
export -f conf_use_root
export -f restore_config
export -f a1_compat_mode
export -f clean_system
export -f set_priority_value
